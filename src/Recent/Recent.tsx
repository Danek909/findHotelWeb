        ...
        <section className="Sectionrecentr">
            ...
            <div className="DivCintainerRecent">
                ...
                <div className="DivMinContainer">
                    <img src={`/findHotelWeb/image/1.webp`} alt="delete" loading="lazy" />
                    <h2>
                ...
                <div className="DivMinContainer">
                    <img src={`/findHotelWeb/image/2.webp`} alt="delete" loading="lazy" />
                    <h2>
                ...
                <div className="DivMinContainer">
                    <img src={`/findHotelWeb/image/3.webp`} alt="delete" loading="lazy" />
                    <h2>

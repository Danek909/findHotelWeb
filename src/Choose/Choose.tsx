            ...
            <div className={styles.divContainer}>
                ...
                <div className={styles.divPidContainer}>
                    <div className={styles.divMiniContainer}>
                        <img src="../image/Choose1.webp" alt="delete" loading="lazy" />
                    ...
                    <div className={styles.divMiniContainer}>
                        <img src="../image/Choose2.webp" alt="delete" loading="lazy"/>
                    ...
                    <div className={styles.divMiniContainer}>
                        <img src="../image/Choose3.webp" alt="delete" loading="lazy"/>
                    ...
                    <div className={styles.divMiniContainer}>
                        <img src="../image/Choose4.webp" alt="delete" loading="lazy"/>
